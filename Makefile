...
LINKFLAGS_WASM := -sUSE_SDL=2 -sALLOW_MEMORY_GROWTH=1 -sTOTAL_MEMORY=32768000 -sFORCE_FILESYSTEM -sUSE_WEBGL2=1 -sEXPORTED_RUNTIME_METHODS=[\"ccall\"] -sINCOMING_MODULE_JS_API="['canvas','logReadFiles','printErr','locateFile']" -lidbfs.js -sUSE_ZLIB=1 
DATA           := ddnoise
ifdef DEBUG
